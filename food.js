...
var foodPetNames = ['Croutons','Cilantro','Quinoa','Chive','Baguette','Cheeto','Fondue','Garbanzo','Zucchini','Pistachio','Chowder','Cashew','Cheerio','Sprinkles','Tahini','Linguini','Macaroni','Donut','Ketchup','Horseradish','Salsa','Basmati','Chimchurri','Carbonara','Egg','Fig','Pumpkin','Cupcake','Cake','Croissant','Brioche','Okra','Gumbo','Chili','Raisin','Cookie','Quiche','Dill','Twizzler','Mint','Sushi','Masala','Banana','Dumpling','Frito','Caper','Tarter','Alfredo','Marinara','Gravy','Garlic','Gumdrop','Jello','Kiwi','Kit Kat','Snickers','Lamb Chop','Beans','Goji','Licorice','Spork','Kebab','Mango','Muffin','Mochi','Oreo','Nugget','Ravoli','Rice','Radish','Shrimp','Sesame','Wasabi','Relish','Mustard','Mayo','Quesadilla','Pinto','Nacho','Sugar','Toast','Biscuit','Wonton','Ziti','Honey','Pesto','Pickle','Hotdog','Aioli','Plum','Peanut','Pepper Jack','Berry','Angus','Honeydew','Arugula','Babybel','Boba','Bagel','Chickpea','Tortilla','Pepper','Popsicle','Pepperoni','Rigatoni','Olive','Ginger','Panini','Pretzel','Hoagie','Polenta','Chia','Crunchwrap','Almond','Pringle','Kumquat','Brie','Cheddar',];
